...
TEST (UtilsTest, GenerateTerseFormatString)
{
  ...
  struct {
    ...
    { g_date_time_ref(arbitrary_day), g_date_time_ref(arbitrary_day), "%H:%M" }, /* identical time */
    { g_date_time_ref(arbitrary_day), g_date_time_add_hours(arbitrary_day,1), "%H:%M" }, /* later today */
    { g_date_time_ref(arbitrary_day), g_date_time_add_days(arbitrary_day,1), "Tomorrow" EM_SPACE "%H:%M" }, /* tomorrow */
    { g_date_time_ref(arbitrary_day), g_date_time_add_days(arbitrary_day,2), "%a" EM_SPACE "%H:%M" },
    { g_date_time_ref(arbitrary_day), g_date_time_add_days(arbitrary_day,6), "%a" EM_SPACE "%H:%M" },
    { g_date_time_ref(arbitrary_day), g_date_time_add_days(arbitrary_day,7), "%d %b" EM_SPACE "%H:%M" }, /* over one week away */
